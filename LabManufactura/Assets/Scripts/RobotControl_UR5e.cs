...
public class RobotControl_UR5e : MonoBehaviour {
	public static float robotJ1SliderValue = 0;
	...
	void Update () {
		...
		RobotJ4.Rotate (0, 0, robotJ4SliderValue * J4TurnRate);
		RobotJ5.Rotate (robotJ5SliderValue * J5TurnRate, 0,0 );
		RobotJ6.Rotate (0, 0, robotJ6SliderValue * J6TurnRate);
